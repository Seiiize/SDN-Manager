...
const RyuController = () => {
  ...
  const ryuControllerTerminals = terminals.ryuController;
  ...
  const addTerminal = () => {
    setTerminals({
      ...terminals,
      ryuController: [
        ...ryuControllerTerminals,
        ryuControllerTerminals.length + 1,
      ],
    });
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        {showTerminals &&
          ryuControllerTerminals.map((terminal) => (
            <iframe
              key={terminal}
